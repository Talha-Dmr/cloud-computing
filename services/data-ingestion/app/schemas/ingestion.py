...
class DataIngestionRequest(BaseModel):
    ...
    device_id: str = Field(..., min_length=3, max_length=100, description="Device identifier")
    data: List[DataPoint] = Field(..., min_items=1, max_items=1000, description="List of data points")
    batch_id: Optional[str] = Field(None, description="Batch identifier for grouping related data")
    location: Optional[Dict[str, Any]] = Field(None, description="Device location information")
